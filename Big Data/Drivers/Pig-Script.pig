--drivers
drivers = LOAD '/data/drivers.csv' USING PigStorage(',');
raw_drivers = FILTER drivers BY $0>1;
drivers_details = FOREACH raw_drivers GENERATE $0 AS driverId, $1 AS name;

--timesheet and combine uniquely
timesheet = LOAD '/data/timesheet.csv' USING PigStorage(',');
...
--sum hours miles into sum_logged group
